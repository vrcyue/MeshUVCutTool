...
namespace vrc_yue.MeshUVCutTools.Core
{
    public class WindowBase : EditorWindow
    {
        ...
        public static void Signature()
        {
            ...
            EditorGUILayout.LabelField( "MeshUVCutTool @vrc_yue" ,signature);
            ...
            EditorGUILayout.LabelField( "Based on MeshModifyTool(にゃんにゃんメッシュエディター) @HhotateA_xR" ,signature);
            EditorGUILayout.LabelField( "Version " + "1.31.01" ,signature);
            EditorGUILayout.LabelField( "https://github.com/HhotateA/AvatarModifyTools" ,signature);
        }
